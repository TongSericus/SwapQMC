...
# this script is assumed to run on Slurm
...
const filename = "num_U$(system.U)_Delta$(system.Δ)_beta$(system.β)_$(file_id).jld"

run_swap_gce(extsys, qmc, 2, path, filename)